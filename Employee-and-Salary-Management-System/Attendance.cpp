...
int Attendance::getPersonalLeave() const { return personalLeave; }
int Attendance::getSickLeave() const { return sickLeave; }
int Attendance::getLateHour() const { return lateDate; }

string Attendance::print() const {
    stringstream ss;
