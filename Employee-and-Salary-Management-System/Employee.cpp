...
Employee::Employee() :baseSalary(0) { numOfEmployee++; }
Employee::Employee(string id, string name, string type, double baseSalary, Attendance attend) :id(id), name(name), type(type), baseSalary(baseSalary), attend(attend) { numOfEmployee++; }
